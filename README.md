...
1. [URL](#URL)にアクセスする
2. アカウントを作る ボタンをクリックする
3. Username と Password を入力する
4. Sign Up ボタンをクリックする
5. 画像検索を利用する
...
2. 検索欄に検索ワードを入力する<br>(検索候補の表示 ボタンのクリックでの入力もできます)
3. Search ボタンをクリックする
...
| サインイン | サインアップでユーザー登録をしたことがあるユーザーは、サインインでアプリケーションを利用することができます。<br>入力には、Username と Password が必要です。 |
...
[Recursion](https://recursionist.io/)というサービスで、ソフトウェアの基礎(コンピュータサイエンス、バックエンド)を学びました。
...
WebAPIには、様々なものがGithubで公開されており、テーマを決めるのに議論しましたが、画像を提供できるAPIを作成したいという話にまとまり開発がスタートしました。
